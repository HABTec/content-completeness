import './contentCompletenessModule';
...
import '../components/content-completeness/content-completeness-controller.js'
...
/* App Module */
angular.module('contentCompleteness')
...
.config(function($httpProvider, $routeProvider, $translateProvider, $logProvider) {
    ...
    $routeProvider.when('/contentCompleteness', {
        templateUrl:'components/content-completeness/home.html',
        controller: 'contentCompletnessController'
    }).otherwise({
        redirectTo : '/contentCompleteness'
    });
